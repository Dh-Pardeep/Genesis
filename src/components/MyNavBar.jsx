      ...
      <div className='mycontainer'>
        <nav className='d-flex align-items-center justify-content-between py-4'>
          ...
          <ul className={`${ showNavbar ? 'd-flex align-items-center mb-0 nav_sm p-0 ' : ' d-flex align-items-center mb-0 nav_sm nav_show p-0'} `}>
            <li><Link onClick={() => setShowNavbar(true)} className="ff_Fontspring_regular nav_hover position-relative color_black font_sm d-inline-block " to="/" >HOME</Link></li>
            ...
            <li><Link onClick={() => setShowNavbar(true)} className="ff_Fontspring_regular nav_hover position-relative font_sm ms_lg_30 mt-4 mt-lg-0 d-inline-block GENESIS" to="Genesis" >GENESIS</Link></li>
